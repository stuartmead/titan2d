...
//Get a pile elevation (needs grid as an input)
...
//! Return e-w and n-s resolutions from the static gis_grid structure. For Gis, GisApi.C:set_from_header sets wresolution=resolution=e-w resol.
//! For Gdal, GdalApi.cc:Initialize_GDAL_data sets wresolution=e-w resol and sets resolution=n-s resol
